...
<body>
    ...
    <div class="main">
        ...
        <div class="body">
        <h1><?php echo "Food Menu :"?></h1><br><br>
...
<?php
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                <img class="card-img-top" src="<?= $row['image']; ?>" alt="<?= $row['name']; ?>" width="150">
                </td>
                <td>
                    <?php echo $row['name']?>
                </td>
                ...
                <td> 
                    <button class="btn1"><a href="deletefood.php?id=<?php echo $row['id']?>">Delete</a></button>
                </td>
            </tr>
            <?php 
            $i++;
