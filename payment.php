...
<body>
    ...
    <div class="greet" style="background-color: #ff81008f;">
        ...
        <button class="btn1" id="rzp-button1"><a>Pay Now</a></button>
        <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
        <script>
            var options = {
                "key": "rzp_test_qt27UzI3bHCSsz", // Enter the Key ID generated from the Dashboard
                "amount": "<?php echo 100*$tp ?>", // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
                "currency": "INR",
                "name": "VIT Canteen",
